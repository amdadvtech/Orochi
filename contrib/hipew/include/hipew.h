...
typedef struct hipSurfaceObject_st* hipSurfaceObject_t;
...
typedef hipError_t HIPAPI thipExternalMemoryGetMappedMipmappedArray(hipMipmappedArray_t *mipmap, hipExternalMemory_t extMem, const struct hipExternalMemoryMipmappedArrayDesc * mipmapDesc);
typedef hipError_t HIPAPI thipGetMipmappedArrayLevel(hipArray *levelArray, hipMipmappedArray_t mipmappedArray, unsigned int level);
